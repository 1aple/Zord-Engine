...
function onUpdatePost(elapsed)
    ...
    if ratingName == '?' then
        local beforeScoreTxt = 'Score: 0 | Misses: 0 | Accuracy: 0.00% | Rating: ? - ???'
        ...
        local finalScoreTxt = 'Score: '..score..' | Misses: '..misses' | Accuracy: '..ratingFullAsStr..'% | Rating: '..tempRatingNameVery..' - '..ratingNameM..''
